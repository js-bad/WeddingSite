...
import home2Logo from '../images/home2Logo.png';
import holidayInnExpressLogo from '../images/holidayInnExpressLogo.png';
import springHillSuitesLogo from '../images/springHillSuitesLogo.png';
...
export default function Location(props) {
    ...
    const home2Link = "https://www.hilton.com/en/book/reservation/rooms/?ctyhocn=MSPROHT&arrivalDate=2023-04-21&departureDate=2023-04-23&room1NumAdults=2&ownerVIPRate=false&brandCode=HH&inputModule=HOTEL_SEARCH";
    const holidayInnExpressLink = "https://www.ihg.com/holidayinnexpress/hotels/us/en/find-hotels/select-roomrate?fromRedirect=true&qSrt=sBR&qSlH=mspro&qRms=1&qAdlt=2&qChld=0&qCiD=21&qCiMy=032023&qCoD=23&qCoMy=032023&qAAR=6CBARC&qRtP=6CBARC&setPMCookies=true&qSHBrC=EX&qDest=2715%20Long%20Lake%20Road,%20Roseville,%20MN,%20US&qpMn=0&srb_u=1";
    const springHillSuitesLink = "https://www.marriott.com/en-us/hotels/mspst-springhill-suites-st-paul-arden-hills/overview/";
    ...
    return(
        <div className="straight-font">
            ...
            <div>
                ...
                <div style={{display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'space-around', flexWrap: 'wrap'}}>
                    <a 
                        href={hiltonBookLink} 
                    ...
                    <a 
                        ...
                        <div style={{display: 'flex', flexDirection: 'column'}}>
                            ...
                            <div style={{fontWeight: 'bold'}}>Home2 Suites by Hilton - Roseville</div>
                            <div className='divider' style={{margin: '3px 0'}}></div>
                            <div>2020 Iona Lane West</div>
                            <div>Roseville, MN 55113</div>
                        </div>
                        <img src={home2Logo} id="home2Logo" />
                    </a>
                    <a 
                        href={holidayInnExpressLink} 
                        className={`hotel-button${isMobile ? ' hotel-button-mobile' : ''}`}>
                        <div style={{display: 'flex', flexDirection: 'column'}}>

                            <div style={{fontWeight: 'bold'}}>Holiday Inn Express: Roseville-St. Paul</div>
                            <div className='divider' style={{margin: '3px 0'}}></div>
                            <div>2715 Long Lake Road</div>
                            <div>Roseville, MN 55113</div>
                        </div>
                        <img src={holidayInnExpressLogo} id="holidayInnExpressLogo" />
                    </a>
                    <a 
                        href={springHillSuitesLink} 
                        className={`hotel-button${isMobile ? ' hotel-button-mobile' : ''}`}>
                        <div style={{display: 'flex', flexDirection: 'column'}}>

                            <div style={{fontWeight: 'bold'}}>Spring Hill Suites - Arden Hills</div>
                            <div className='divider' style={{margin: '3px 0'}}></div>
                            <div>3920 Northwoods Drive</div>
                            <div>Arden Hills, MN 55112</div>
                        </div>
                        <img src={springHillSuitesLogo} id="springHillSuitesLogo" />
                    </a>
